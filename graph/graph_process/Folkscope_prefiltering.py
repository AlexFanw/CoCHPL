...
electronic_review = pd.read_csv("/home/datasets/wwangbw/Electronics.csv", index_col=None,
                                names=['asin', 'reviewerID', 'rating', 'time'], header=None).drop(['time'], axis=1)
clothing_review = pd.read_csv("/home/datasets/wwangbw/Clothing_Shoes_and_Jewelry.csv", index_col=None,
                              names=['asin', 'reviewerID', 'rating', 'time'], header=None).drop(['time'], axis=1)
...
MAVE_data = pd.read_csv("/home/datasets/wwangbw/AmazonMetadata_merge_MAVE.csv", index_col=None)
...
electronic_folkscope = pd.read_csv("/home/datasets/wwangbw/data_FINAL/elec_FINAL.csv", index_col=None)
clothing_folkscope = pd.read_csv("/home/datasets/wwangbw/data_FINAL/clothing_FINAL.csv", index_col=None)
...
np.save('/home/datasets/wwangbw/AlexCRS/reviewer_id2interaction_dict.npy', reviewer_id_dict)
np.save('/home/datasets/wwangbw/AlexCRS/item_asin2id_dict.npy', {ind: i for ind, i in enumerate(asin_list)})
...
review_record.to_csv("/home/datasets/wwangbw/AlexCRS/review_filtered.csv", index=False)
...
folkscope_selected.to_csv("/home/datasets/wwangbw/AlexCRS/folkscope_filtered.csv", index=False)

MAVE_data_filtered = MAVE_data[MAVE_data.asin.isin(asin_list)].reset_index(drop=True)
print(len(MAVE_data_filtered))
MAVE_data_filtered.to_csv("/home/datasets/wwangbw/AlexCRS/MAVE_filtered.csv", index=False)
