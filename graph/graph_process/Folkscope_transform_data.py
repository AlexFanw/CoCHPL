...
review = pd.read_csv("/home/datasets/wwangbw/AlexCRS/review_filtered.csv", index_col=None)
print(review.head(3), '\n\n')
attribute = pd.read_csv("/home/datasets/wwangbw/AlexCRS/MAVE_filtered.csv", index_col=None)
print(attribute.head(3), '\n\n')
intention = pd.read_csv("/home/datasets/wwangbw/AlexCRS/folkscope_filtered.csv", index_col=None)
print(intention.head(3), '\n\n')

asin_index2id_dict = np.load("/home/datasets/wwangbw/AlexCRS/item_asin2id_dict.npy", allow_pickle=True).item()
reviewer_id_dict = np.load("/home/datasets/wwangbw/AlexCRS/reviewer_id2interaction_dict.npy", allow_pickle=True).item()
