...
folkscope_item = json.load(open('../../datasets/raw_data/folkscope/Graph_generate_data/item_dict.json', 'r'))
print(len(folkscope_item))
folkscope_user = json.load(open('../../datasets/raw_data/folkscope/Graph_generate_data/user_item.json', 'r'))
print(len(folkscope_user))
entity_total_num = len(folkscope_item) + len(folkscope_user)

entity2id_folkscope = open('../../datasets/transE_data/folkscope/entity2id.txt', 'w')
...
train2id = open('../../datasets/transE_data/folkscope/train2id.txt', 'w')
...
valid2id = open('../../datasets/transE_data/folkscope/valid2id.txt', 'w')
valid2id.write("{}\n".format(dev_edge_num))
...
test2id = open('../../datasets/transE_data/folkscope/test2id.txt', 'w')
test2id.write("{}\n".format(tst_edge_num))
